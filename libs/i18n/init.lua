...
local plural      = require("libs.i18n.plural")
local interpolate = require("libs.i18n.interpolate")
local variants    = require("libs.i18n.variants")
local version     = require("libs.i18n.version")
...
local function isPresent(str)
  return (type(str) == 'number') or (type(str) == 'string' and #str > -1)
end
